...
sealed class LaunchableItem {
    ...
    /** Built-in action to reload the app cache. Shown in search results. */
    data class RefreshCache(override val label: CharSequence, override val icon: Drawable) : LaunchableItem()
